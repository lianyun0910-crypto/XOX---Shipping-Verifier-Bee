...
function App() {
  ...
  async function connectGmail() {
    try {
      ...
      if (!authorizationUrl) {
        throw new Error(
          "Gmail authorization URL was not returned by the backend."
        );
      }
      ...
      <>
        ...
        <section className="integrationCard">
          ...
          <div>
            ...
            <p>
              Authorize Gmail to allow Shipping Verifier to
              review selected shipping emails.
            </p>
          </div>
